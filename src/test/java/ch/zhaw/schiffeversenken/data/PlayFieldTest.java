...
public class PlayFieldTest {
	...
	public void	testGetPossibleShipPositionsionsAround1stHit() {
		...
		assertTrue("Second shot position after hitting the upper left corner not correct", possibleShipPosition0_0.equals(coordinate0_0South) || 
		...
		assertTrue("Second shot position after hitting the upper right corner not correct", possibleShipPositionMax_0.equals(coordinateMax_0West) || 
		...
		assertTrue("Second shot position after hitting the lower left corner not correct", possibleShipPosition0_Max.equals(coordinate0_MaxEast) || 
		...
		assertTrue("Second shot position after hitting the upper right corner not correct", possibleShipPositionMax_Max.equals(coordinateMax_MaxWest) || 
		...
		assertTrue("Second shot position after hitting the upper right corner not correct", possibleShipPosition10_0.equals(coordinate10_0West) || 
				possibleShipPosition10_0.equals(coordinate10_0East) || possibleShipPosition10_0.equals(coordinate10_0South));
		...
		assertTrue("Second shot position after hitting the upper left corner not correct", possibleShipPosition0_10.equals(coordinate0_10North) || 
				possibleShipPosition0_10.equals(coordinate0_10South) || possibleShipPosition0_10.equals(coordinate0_10East));
		...
		assertTrue("Second shot position after hitting the lower left corner not correct", possibleShipPosition10_Max.equals(coordinate10_MaxWest) || 
				possibleShipPosition10_Max.equals(coordinate10_MaxEast) || possibleShipPosition10_Max.equals(coordinate10_MaxNorth));		
		...
		assertTrue("Second shot position after hitting the upper right corner not correct", possibleShipPositionMax_10.equals(coordinateMax_10North) || 
				possibleShipPositionMax_10.equals(coordinateMax_10South) || possibleShipPositionMax_10.equals(coordinateMax_10West));
		...
		assertTrue("Second shot position after hitting a center field is not correct", possibleShipPosition10_10.equals(coordinate10_10West) || 
				possibleShipPosition10_10.equals(coordinate10_10East) || possibleShipPosition10_10.equals(coordinate10_10North) || 
				possibleShipPosition10_10.equals(coordinate10_10South));
	}
	
	@Test
	public void testgetShipPositionsionsFurtherHits() {
		//Testing if the third shot of a top left ship is correct. The ship is initialized under @Before
		playField.addShip(ship);
		playField.processShot(coordinates.get(0));
		playField.processShot(coordinates.get(1));
		assertTrue("Third shot on a corner ship not correct", playField.getShipPositionsionsFurtherHits(ship.getWoundPositions().get(1), ship).equals(new Coordinate(0, 2, false, false)));
		...
		Coordinate shipPositionFurtherHits1 = playField.getShipPositionsionsFurtherHits(ship1.getWoundPositions().get(0), ship1);
		assertTrue("Third shot on a central ship with central hit not correct", shipPositionFurtherHits1.equals(new Coordinate(10, 6, false, false)) ||
		...
		Coordinate shipPositionFurtherHits2 = playField.getShipPositionsionsFurtherHits(ship2.getWoundPositions().get(0), ship2);
		assertTrue("Third shot on a central ship with 1st position hit 1st not correct", shipPositionFurtherHits2.equals(new Coordinate(15, 16, false, false)));
		...
		Coordinate shipPositionFurtherHits3 = playField.getShipPositionsionsFurtherHits(ship3.getWoundPositions().get(1), ship3);
		assertTrue("Third shot on a central ship with 2nd position hit 1st not correct", shipPositionFurtherHits3.equals(new Coordinate(20, 21, false, false)) ||
